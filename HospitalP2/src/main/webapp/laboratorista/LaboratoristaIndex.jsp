...
<html>
    ...
    <center><div style="color:white;">
            <p>Aqui podra crear examenes que han sido programadas anteriormente .</p>
            <p>Puede acceder a la informacion de los pacientes asi como poder consultar</p>
            <p>los examenes que se deben realizar.</p>
            <p>Tambien podra acceder a su historial y mostrar toda su informacion.</p>
