...
<html>
    ...
    <body>
        ...
        %>
        <table id="customers"><tr><th>Codigo</th><th>Fecha</th><th>Hora</th><th>Tipo</th><th>Medico</th><th>Eliminar</th></tr>
                    <%
                        while (resultset01.next()) {
                            ...
                            out.println("<td>" + resultset01.getObject("especialidad_nombre") + "</td>");
                                        %><td><center><a class="button2" href="VerCitaConsulta.jsp?eliminar=<%=resultset01.getInt("codigo")%>">Cancelar consulta</a></center></td><%
                                                out.println("</tr>");
                                            }
