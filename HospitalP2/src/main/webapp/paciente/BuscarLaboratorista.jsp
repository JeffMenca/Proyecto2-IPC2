...
<html>
    ...
    <body>
        ...
        <form method="GET" action="BuscarLaboratorista.jsp">
            <div class="box">
                <select name="tipo">
                    ...
                    <%
                        while (resultset01.next()) {
                            ...
                            out.println("<td>" + resultset01.getObject("nombre_Examen") + "</td>");
                                    %><td><center><a class="button" href="AgendarExamen.jsp?codigo=<%=resultset01.getString("codigo")%>">Programar examen</a></center></td><%
                                        out.println("</tr>");
                                    }
